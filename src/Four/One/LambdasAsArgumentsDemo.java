...
public class LambdasAsArgumentsDemo {
    //This is method has a functional interface as the type of its
    //first parameter. Thus, it can be passwd a reference to any
    //instance of that interface, including the instance created by a
    //lambda expression
    //The second parameter specifies the string to operate on.
  /*  static String stringOp(String sf, String s){
        return sf.func(s);
    }
*/
    public static void main(String[] args) {
       /* String inStr = "Lambdas add power to Java";
        ...
        //Here, a simple expreesion lambda that uppercases a string is passed to stringOp().
        ...
        //Of course,it is alose possible to pass a StringFunc instance
